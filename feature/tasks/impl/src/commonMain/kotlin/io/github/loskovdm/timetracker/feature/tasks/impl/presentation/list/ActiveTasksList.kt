...
internal fun ActiveTasksList(
    ...
    when (val currentState = state) {
        ...
        is TasksListState.Empty -> EmptyScreen(
            ...
            headline = stringResource(Res.string.no_tasks),
            hint = stringResource(Res.string.add_task_hint)
        )
        is TasksListState.Loaded -> LoadedActiveTasksList(
...
@OptIn(ExperimentalUuidApi::class)
@Composable
private fun LoadedActiveTasksList(
    tasksList: List<Task>,
    onTaskClick: (projectId: Uuid, taskId: Uuid) -> Unit,
